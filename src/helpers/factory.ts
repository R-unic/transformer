...
export namespace f {
	...
	export namespace update {
		...
		export function decorator(decorator: ts.Decorator, expression: ts.Expression = decorator.expression) {
			return factory.updateDecorator(decorator, expression);
		}
	}
